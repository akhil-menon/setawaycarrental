<?php
    class Local_Transfer_price_model extends CI_Model{
        ...
        public function local_transfer_price_list(){
            return $this->db->get_where('local_transfer_price_master',array('is_active'=>'1'))->result();
        }
